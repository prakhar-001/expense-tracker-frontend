...
const page = () => {
  ...
  return (
    ...
    <div className='flex items-center flex-col justify-center mt-10 sm:mt-16 mx-auto border-2 shadow-2xl mb-24 rounded-xl w-11/12 sm:w-2/5 p-5 bg-blue-100 dark:bg-gray-400'>
            ...
            <form action="" onSubmit={submitHandler} className='w-5/6 sm:w-9/12 flex flex-col gap-5 items-center mb-8'>
                ...
                {
                    enableButton? 
                    <button type='submit' className='p-2 border-2 rounded-xl w-32 hover:shadow-green-300 shadow-xl font-semibold'>Sign Up</button>
                    :
                    <div className='p-2 px-5 border-2 rounded-xl w-auto hover:shadow-red-300 shadow-xl font-semibold'>Sign Up</div>
                }
            </form>
            <div className='flex gap-5'> 
                <Link href={"/logIn-email-pass"}>
                    <div>
                        <button className='p-2 w-32 mb-1 border-2 hover:shadow-slate-400 rounded-xl shadow-xl font-semibold'>Log In</button>
                    </div>
                </Link>
                {/* {
                    userValue? */}
