...
export default function Home() {
  const {user, loading, theme} = useSelector(state => state.userReducer)
...
const toggleExpenseForm = () => {
  ...
  return (
    ...
    <main className="flex flex-col sm:flex-row justify-between sm:pt-0 pb-0 gap-2 sm:gap-5 h-screen sm:h-full w-auto mx-2 sm:mx-20 sm:px-2">
    ...
    <div className="w-full sm:w-1/4 h-auto flex flex-col gap-2">
      ...
      <div className="w-full flex justify-around">
        <button onClick={toggleIncomeForm} className="bg-green-400 dark:bg-slate-900 dark:text-white font-semibold p-3 rounded-xl w-32">
          <h1>Add Income</h1>
        </button>
        <button onClick={toggleExpenseForm} className="bg-red-400 dark:bg-slate-900 dark:text-white font-semibold p-3 rounded-xl w-32">
          <h1>Add Expense</h1>
        </button>
      </div>
      ...
      <div className="flex flex-col items-center w-full">  
        ...
        {
          addIncomeOpen && 
          <div className="flex flex-col items-center border-2 w-full h-max bg-slate-200 dark:bg-gray-400 rounded-xl px-5 py-3">
            ...
            <form onSubmit={handleSubmitIncome} className="flex flex-col w-full px-5">
              ...
              <button type="submit" className="p-2 w-40 mx-auto rounded-xl bg-green-400 dark:bg-slate-800 dark:text-white font-semibold mt-2">Add Income</button>            
          </form>
        </div>
        }
        ...
        {/* EXPENSE */}
        {
          ...
          <div className="flex flex-col items-center border-2 w-full h-max bg-slate-200 dark:bg-gray-400 rounded-xl px-5 py-3">
            ...
            <form onSubmit={handleSubmitExpense} className="flex flex-col w-full px-5">
              ...
              <button type="submit" className="p-2 w-40 mx-auto rounded-xl bg-red-400 dark:bg-slate-800 dark:text-white font-semibold mt-2">Add Expense</button>
            </form>
        </div>
        }
      </div>
    ...
    <div className=" w-full sm:w-3/4 h-full flex flex-col gap-4 sm:gap-8">
      ...
      <div className="text-base flex justify-evenly sm:justify-end gap-5 mx-0 w-full sm:mx-0 mt-2 sm:mt-0 h-8">
            ...
            }} className='rounded-xl px-2 border-2 border-blue-400 bg-white dark:border-slate-900'>
            ...
            <select value={selectedYearExpense} onChange={(e) => {setSelectedYearExpense(e.target.value), setSelectedYearIncome(e.target.value)}} className='rounded-xl px-2 border-2 border-blue-400 bg-white dark:border-slate-900'>
      ...
      <div className='w-full flex flex-col sm:flex-row flex-wrap gap-5 justify-end items-center text-lg'>
        <div className="flex flex-wrap w-full sm:w-11/12">
          <div className='w-full sm:w-1/2 h-56 sm:h-64 p-2'> 
            <h1 className='text-black dark:text-white font-semibold mt-2'>Expenses Yearly Analysis</h1>
            <Line data={lineDataExpense} options={lineOptions} className='w-full h-auto sm:w-auto sm:h-72 p-0 m-0' ></Line>
          </div>
          <div className='w-full sm:w-1/2 h-56 sm:h-64 p-2'>
            <h1 className='text-black dark:text-white font-semibold mt-2'>Incomes Yearly Analysis</h1>
            <Line data={lineDataIncome} options={lineOptions} className='w-full h-auto sm:w-auto sm:h-72 p-0 m-0' ></Line>
          </div>
          <div className='w-full sm:w-1/2 h-56 sm:h-64 p-2'> 
            <h1 className='text-black dark:text-white font-semibold mt-2'>Financial Analysis</h1>
      ...
      {/* <div className='w-full flex flex-col sm:flex-row gap-2 mt-5'>
        <div className='w-full sm:w-2/3 h-56 sm:h-52'> 
